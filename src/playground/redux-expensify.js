...
const filtersReducer = (state = filterReducerDefaultState, action) => {
  switch (action.type) {
    case 'SET_TEXT_FILTER':
      return {
        ...state, // '...' grabs all values from state
        text: action.text
      };
    case 'SORT_BY_DATE':
      return {
...
// timestamps - any positive or negative integer (milliseconds)
// January 1st 1970 (unix epoch) - starting point for all of our timestamps
// 33400, 10, -203
